...
#define UL1 21   // Upper Left  motor IN1
#define UL2 22   // Upper Left  motor IN2
#define UR1 19   // Upper Right motor IN1
#define UR2 18   // Upper Right motor IN2
#define DL1 4    // Down  Left  motor IN1
#define DL2 5    // Down  Left  motor IN2
#define DR1 17   // Down  Right motor IN1
#define DR2 16   // Down  Right motor IN2
